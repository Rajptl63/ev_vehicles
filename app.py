...
# === Load model ===
model = joblib.load('ev-vehicles-repo/ev_vehicles/forecasting_ev_model.pkl')
...
# Image
st.image("ev-vehicles-repo/ev_vehicles/ev-car-factory.jpg", use_container_width=True)
